...
export const GENRES = {
  ...
  tv: [
    { id: 10759, name: 'Action et aventure' },
    { id: 16, name: 'Animation' },
    { id: 35, name: 'Comédie' },
    { id: 80, name: 'Crime' },
    { id: 99, name: 'Documentaire' },
    ...
    { id: 10765, name: 'Science-fiction et fantastique' },
    { id: 10766, name: 'Feuilleton' },
    { id: 37, name: 'Débat' },
    { id: 10767, name: 'Guerre et politique' },
...
export const SPECIAL_CATEGORIES = {
  movie: [
    { id: -1, name: 'Films d’animation japonaise' },
    { id: -2, name: 'Films thaïlandais' },
    { id: -3, name: 'Films coréens' },
    { id: -4, name: 'Films chinois' },
  ],
  tv: [
    { id: -1, name: 'Animation japonaise' },
    { id: -2, name: 'Séries coréennes' },
    { id: -3, name: 'Séries chinoises' },
    { id: -4, name: 'Donghua' },
    { id: -5, name: 'Séries thaïlandaises' },
  ],
};
